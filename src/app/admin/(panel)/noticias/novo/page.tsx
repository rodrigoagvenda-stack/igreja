    ...
    <div className="p-8 max-w-[700px] w-full mx-auto">
      <div className="flex items-end justify-between mb-8 pb-6 border-b border-border">
        <div>
          ...
          <h1 className="font-serif text-[28px] font-bold">Nova notícia</h1>
        </div>
      </div>

      <form action={createNoticia} className="space-y-6">
        <div className="bg-card ring-1 ring-foreground/10 rounded-xl p-6 space-y-5">
          <div>
            <label className={labelCls}>Título *</label>
            <input name="titulo" required className={inputCls} placeholder="Título da notícia" />
          </div>
          ...
          <div>
            ...
            <textarea name="resumo" rows={3} className={inputCls + " resize-y"} placeholder="Breve descrição da notícia" />
          </div>

          <div>
            <label className={labelCls}>Conteúdo</label>
            <textarea name="conteudo" rows={10} className={inputCls + " resize-y"} placeholder="Texto completo da notícia" />
          </div>

          <div>
            <label className={labelCls}>URL da imagem</label>
            <input name="imagem_url" type="url" className={inputCls} placeholder="https://..." />
          </div>
